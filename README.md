...
The course aims to empower the participants with the flexibility that the R+tidyverse framework gives to visualize data (the practical examples mostly use demographic data). The course covers some aspects of data visualization theory and best/worst practice examples, but it's primarily practice oriented including live coding sessions and short lecture/showcase parts. Practical examples cover the creation of certain most useful types of plots. Important data visualization choices and caveats are discussed along the way. 

# Full course: [GitHub](https://github.com/ikashnitsky/dataviz-art-skill) | BlueSky account: [@datavizartskill.ikashnitsky.phd](https://bsky.app/profile/datavizartskill.ikashnitsky.phd)


# Prerequisites
- [R](https://cloud.r-project.org)  
- [Rstudio](https://www.rstudio.com/products/rstudio/download/#download) or [Positron](https://positron.posit.co/install.html)  
...
- [#30DayChartChallenge 2021](https://github.com/ikashnitsky/30DayChartChallenge)
- [#30DayMapChallenge 2023](https://github.com/ikashnitsky/30DayMapChallenge)
- [#30DayChartChallenge 2026](https://github.com/ikashnitsky/30DayChart2026)
